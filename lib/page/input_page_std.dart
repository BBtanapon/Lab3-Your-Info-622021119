...
import 'package:flutter_input_username/model/colors.dart';
        ...
        Padding(
          ...
          child: Container(
            ...
            child: CheckboxListTile(
              value: team.checked,
              title: Text(team.colorname!),
              onChanged: (value) {
                setState(() {
                  team.checked = value;
                });
                if (value!) {
                  checkTeam.add(team.colorname);
                } else {
                  checkTeam.remove(team.colorname);
                }
              },
            ),
          ),
